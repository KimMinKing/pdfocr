# -*- coding: utf-8 -*-
"""
D3x50 — QPULSE_BB 전략  (D3 필터 + 50x 레버리지)
...
[설정 요약]
  ...
  거래량 배수  : 0.90x (D3)
  레버리지     : 50x
  포지션 비율  : 50% per symbol (멀티심볼: 최대 2개 동시)
  백테스트 성과 (1년 BTC, 30x→50x 환산):
    총 수익률 +1,558,285%  |  MDD 15.16%  |  승률 70.3%  |  쿨다운 11회/년 (DD정지 0회)

[멀티심볼 포지션 규칙]
  - BTC/ETH/XRP 중 신호 발생 시 계좌의 50% 진입
  - 동시 최대 2개 심볼 포지션 보유
  - 3번째 신호는 차단 (앞 2개 청산 후 재진입 가능)
...
# [v8] QP-BB 진입 필터
QPULSE_BB_BAND_EDGE_RATIO = 0.45  # BB 밴드 외곽 45% 영역에서만 진입 (D3)
QPULSE_BB_VOL_MULT        = 0.90  # 진입 시 거래량이 20봉 평균의 0.90배 이상이어야 함 (D3)
