# -*- coding: utf-8 -*-
"""
Bybit BTC 고급 매매봇 v7 — B변형x50 (EMA 8/21 + D4c 필터 + 50x 레버리지)

[이 파일은 abb_lab1_ema8.py 기반 + D4c 설정 최종]
  EMA 8/21  |  D4c 필터 (VOL 0.85x / BB 50%)  |  LEVERAGE 50x  |  멀티심볼 50%/건

  백테스트 결과 (1년 BTC, 2025-03-01 ~ 2026-03-01, 50x):
    총 수익률: +2,943,937%   (D3x50 EMA12/26 대비 +89%)
    MDD:       9.87%         (D3x50 15.16% 대비 35% 낮음) ← 안정적
    칼마비율:  298,250       (D3x50 102,814 대비 3배)
    승률:      72.2%
    총 거래수: 400건
    손실 월:   0개월
    쿨다운:    7회/년 (30분씩)
...
BASE_POSITION_RATIO = 0.50  # 멀티심볼: 계좌의 50%씩 (최대 2개 동시 포지션)
LEVERAGE = 50.0             # Bx50
...
# EMA 교차 파라미터 (B 변형: 8/21 — 표준 12/26보다 빠름, MDD 개선)
QPULSE_EMA_SHORT = 8
QPULSE_EMA_LONG = 21
